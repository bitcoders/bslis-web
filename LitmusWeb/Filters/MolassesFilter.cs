...
{
    public class MolassesFilter : FilterAttribute, IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext filterContext)
        {
            if (filterContext.HttpContext.Session.Contents["UserCode"] != null)
            {
                ...
                var molassesList = subCategoryRepository.GetMasterParameterCategoriesByParameterMasterCode(2);
                ...
                filterContext.Controller.ViewBag.MolassesList = molassesList;
            }
        }
    }
}