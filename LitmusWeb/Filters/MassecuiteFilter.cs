...
{
    public class MassecuiteFilter : FilterAttribute, IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext filterContext)
        {
            if (filterContext.HttpContext.Session.Contents["UserCode"] != null)
            {
                ...
                var massecuiteList = subCategoryRepository.GetMasterParameterCategoriesByParameterMasterCode(1);
                ...
                filterContext.Controller.ViewBag.MassecuteList = massecuiteList;
            }
        }
    }
}