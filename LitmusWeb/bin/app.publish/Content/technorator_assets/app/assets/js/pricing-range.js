    ...
    new Dragdealer('pr-slider', {
        animationCallback: function(x, y) {
            ...
            if ( slider_value < pln.plan_min_user_1) {
                ...
                var total_amount_value = priceCalculation(plan_type_value, plan_price, slider_value);
                ...
                $(".annual-price-total").html(pln.plan_currency_symbol+' '+total_amount_value_month);
