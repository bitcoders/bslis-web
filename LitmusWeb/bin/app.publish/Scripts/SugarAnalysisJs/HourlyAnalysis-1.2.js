    ...
    var L31 = L30 = M31 = M30 = S31 = S30 = BISS = Total_L = Total_M = Total_S =0, Raw_Sugar=0, TotalSugarBags = 0
...
$('.SugarBag').change(function () {
        ...
        TotalSugarBags = parseFloat(Total_L) + parseFloat(Total_M) + parseFloat(Total_S) + parseFloat(BISS) + parseFloat(Raw_Sugar);
