...
function bconfirm(message , opts , title , confirm , cancel)
{
	...
	var html = '';
	html += '<div class="modal fade global-modal" id="modal_confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">';
	html += '    <div class="modal-dialog">';
	html += '        <div class="modal-content">';
	html += '            <div class="modal-header">';
	html += '                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>';
	...
	html += '            </div>';
	html += '            <div class="modal-footer">';
	html += '                <button type="button" class="btn btn-default confirm"><span>' + confirm + '</span></button>';
...
function show_error_message(div_id , message, timeout)
{
	var str = "";
